...
def main(dns_name,email,token,ip_address):
    """Cloudflare API code - example"""
...
if __name__ == '__main__':
    email = '898611548@qq.com'
    token = '46e072a3a26a7b88f0ca50230bb79fc82fde1'
    last_ip_address = ''
    while 1:
        ...
        try:
            ...
            if ip_address == last_ip_address:
                ...
                main('test.twblogs.net',email,token,ip_address)
                main('www.smwenku.com',email,token,ip_address)
        except Exception as e:
            ip_address = ''
            logging.error(e)
            continue
        finally:
            logging.info('last_ipaddress:{} , ip_address:{}'.format(last_ip_address,ip_address))
            time.sleep(2)
