...
class Application(tornado.web.Application):
    def __init__(self, dbs):
        ...
        handlers = [
            ...
            (r'/a/(?P<a_id>.*?)/(?P<language>zh-hk|zh-cn|zh-tw)/?', redirect.Article2Handler),
            ...
            (r'/api/article/relatedes', api.ApiRelatedEsHandler),
            ...
            (r'/api/article/relatedes', api.ApiAuthorHandler),
            # (r'/api/comments/add/', article.ApiCommentsAddHandler),
